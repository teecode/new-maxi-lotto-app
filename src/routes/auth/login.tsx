        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex items-center justify-end px-1">
            <Link
              ...
              className="text-xs font-semibold text-slate-400 hover:text-pink-400 transition-colors"
            >
              Forgot password?
            </Link>
          </div>
          ...
          <div className="flex justify-center text-sm font-medium gap-1 text-slate-500 pt-4">
            ...
            <Link
              to="/auth/signup"
              className="text-pink-400 hover:text-pink-300 font-bold hover:underline decoration-2 underline-offset-2"
            >
              Create Account
            </Link>
          </div>
