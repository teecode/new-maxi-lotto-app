...
const socialLinks = [
  ...
  },
  {
    name: "Instagram",
    handle: "@maxilottong",
    href: "https://instagram.com/maxilottong",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: "Facebook",
    handle: "@maxilottong",
    href: "https://facebook.com/maxilottong",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: "TikTok",
    handle: "@maxilottong",
    href: "https://tiktok.com/@maxilottong",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: "LinkedIn",
    handle: "@maxilottong",
    href: "https://linkedin.com/company/maxilottong",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="shadow-none font-poppins">
      <div className="flex bg-gradient-to-b py-8 sm:py-16 from-[#01B1A8] to-[#0185B6]">
        <div className="container">
          <div className="grid grid-cols-1 gap-10 sm:gap-6 sm:grid-cols-5">
            ...
            {/* Social Media */}
            <div>
              <h2 className="mb-2 text-lg font-bold text-[#fff100] capitalize dark:text-white">Follow Us</h2>
              <ul className="text-white text-sm font-medium space-y-3">
                {socialLinks.map((social) => (
                  <li key={social.name}>
                    ...
                    >
                      <span className="opacity-80">{social.icon}</span>
                      {social.name}
                    </a>
                  </li>
                ))}
