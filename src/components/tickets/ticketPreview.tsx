...
import { formatCurrency, fullDateTimeFormat } from "@/lib/utils"
...
export function TicketPreview({ open, setOpen, ticket }: TicketPreviewProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:mx-auto max-w-[95%] sm:max-w-xl mx-auto bg-background p-4 rounded">
        <DialogHeader className="text-left space-y-2">
          <DialogTitle className="font-semibold">Ticket Details</DialogTitle>
                      ...
                      <div className="bg-gray-50 px-3 sm:px-4 py-2 flex justify-between items-center border-b border-gray-100">
                        <div className="flex items-center gap-2">
                          ...
                          {betslip.winningType === 2 && (
                            <Badge variant="outline" className="text-[10px] sm:text-xs bg-purple-50 text-purple-700 border-purple-200">Machine Bet</Badge>
                          )}
                        </div>
                        <Badge
