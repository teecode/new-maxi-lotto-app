...
export const RANKS: RankDefinition[] = [
  ...
  { level: 3, name: "Scorer", minWins: 1, minAmount: 5000, color: "#CD7F32" },
  { level: 4, name: "Pro", minWins: 2, minAmount: 10000, color: "#C0C0C0" },
  { level: 5, name: "Master", minWins: 4, minAmount: 25000, color: "#C0C0C0" },
  { level: 6, name: "Champion", minWins: 4, minAmount: 50000, color: "#FFD700" },
  { level: 7, name: "Legend", minWins: 5, minAmount: 100000, color: "#FFD700" },
  { level: 8, name: "Kingpin", minWins: 7, minAmount: 250000, color: "#E5E4E2" },
  { level: 9, name: "Tycoon", minWins: 10, minAmount: 500000, color: "#E5E4E2" },
  ...
  { level: 15, name: "GOAT", minWins: 35, minAmount: 50000000, color: "#000000" }
];
